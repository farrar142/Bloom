...
class TestTransactionAdviceAsync:
    ...
    async def test_requires_new_async(self):
        ...
        with call_scope():
            tx_ctx1, _ = await self.advice.begin_transaction_async(
                container_required, 1
            )
...
class TestAsyncTransactionEdgeCases:
    ...
    async def test_async_mixed_propagation(self):
        ...
        with call_scope():
            ...
            tx2, is_new2 = await self.advice.begin_transaction_async(
                container_requires_new, 2
            )
            tx3, is_new3 = await self.advice.begin_transaction_async(
                container_supports, 3
            )
