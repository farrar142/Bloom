...
class TestImportFromString:
    ...
    async def test_import_module_and_attribute(self):
        """모듈:속성 형식 임포트"""
        # os.path.join 임포트
    ...
    async def test_import_nested_attribute(self):
        """중첩 속성 임포트"""
    ...
    async def test_module_not_found_raises_error(self):
        """모듈을 찾을 수 없으면 에러"""
        with pytest.raises(ImportError, match="Could not import module"):
            import_from_string("nonexistent_module:something")

    async def test_attribute_not_found_raises_error(self):
        """속성을 찾을 수 없으면 에러"""
...
class TestMainCLI:
    ...
    async def test_task_worker_command_uses_default_application(self, capsys):
    ...
    async def test_task_worker_command_with_explicit_application(self, capsys):
    ...
    async def test_task_without_worker_shows_help(self, capsys):
