...
class MySQLConnection(Connection):
    ...
    def execute(self, sql: str, params: dict[str, Any] | None = None) -> "MySQLConnection":
        # pymysql은 %(name)s 형식 사용
        self._cursor = self._conn.cursor()
        self._cursor.execute(sql, params or {})
        return self
    
    def executemany(self, sql: str, params_list: list[dict[str, Any]]) -> "MySQLConnection":
        self._cursor = self._conn.cursor()
...
class AioMySQLConnection(AsyncConnection):
    ...
    async def execute(self, sql: str, params: dict[str, Any] | None = None) -> "AioMySQLConnection":
        self._cursor = await self._conn.cursor()
        await self._cursor.execute(sql, params or {})
        return self
    
    async def executemany(self, sql: str, params_list: list[dict[str, Any]]) -> "AioMySQLConnection":
        self._cursor = await self._conn.cursor()
...
class MySQLConnectionPool(ConnectionPool):
    ...
    async def acquire_async(self) -> AioMySQLConnection:
        ...
        return AioMySQLConnection(conn)
...
class MySQLBackend(DatabaseBackend):
    ...
    def create_pool(self) -> MySQLConnectionPool:
        return MySQLConnectionPool(self.config)
