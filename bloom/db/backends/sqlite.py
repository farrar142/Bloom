...
class SQLiteConnection(Connection):
    ...
    def __init__(self, conn: sqlite3.Connection, dialect: Dialect):
        self._conn = conn
    ...
    def acquire(self) -> SQLiteConnection:
        if self._is_memory:
            with self._lock:
                ...
                return SQLiteConnection(self._shared_conn, self._dialect)
        ...
        return SQLiteConnection(conn, self._dialect)
...
class SQLiteBackend(DatabaseBackend):
    ...
    def create_pool(self) -> SQLiteConnectionPool:
        return SQLiteConnectionPool(self.config, self._dialect)
